...
import com.pretizy.activitytracker.ui.AllScheduleFragment;
import com.pretizy.activitytracker.ui.ScheduleFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public void switchScreen(Fragment frag){
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().
                replace(R.id.flContent, frag).commit();
